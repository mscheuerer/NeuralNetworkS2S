...
#def build_cat_model(n_xy, n_bins, n_basis, hidden_nodes, par_reg):
...
#    c = MaxPooling2D((2,2))(c)
#    x = Flatten()(c)
#    #x = Concatenate()([c,inp_aux])
#    for h in hidden_nodes:
#        x = Dense(h, activation='elu', kernel_regularizer=regularizers.l1(par_reg))(x)
#    x = Dense(n_bins*n_basis, activation='elu', kernel_regularizer=regularizers.l1(par_reg))(x)
...
### Save out to file
outfilename = "/Users/mscheuerer/Desktop/CalifAPCP/tuning/cnn-m"+str(imod)+"-drpt-f48"
